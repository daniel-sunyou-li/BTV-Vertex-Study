...
class PrimaryVertexSorting {
 public:
  ...
  float score_lep(const reco::Vertex & pv, const std::vector<const reco::Candidate *> & candidates) const;
  float score_jet(const reco::Vertex & pv, const std::vector<const reco::Candidate *> & candidates) const;
  float score_met(const reco::Vertex & pv, const std::vector<const reco::Candidate *> & candidates) const;
